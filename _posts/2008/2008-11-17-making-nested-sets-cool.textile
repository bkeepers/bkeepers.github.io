...
- popular
- rails
alias: /blog/archives/2008/11/17/making-nested-sets-cool
---
...
We created "awesome_nested_set":http://github.com/collectiveidea/awesome_nested_set to try to remedy that.

h3. What makes this so awesome?

There's a lot of things that makes this awesome, but my personal favorite is that awesome_nested_set makes use of Rails 2.1's named_scope features^"1":#named_scope_backport^, so most of the nested set methods return a scope that works as a finder. You can call find methods on it or access other named scopes.
...
<ol class="footnotes">
  <li id="named_scope_backport">It also backports named_scope for those still on Rails 2.0</li>
</ol>
