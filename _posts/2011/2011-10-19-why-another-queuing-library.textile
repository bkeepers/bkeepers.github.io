...
- qu
- ruby
excerpt: "Along with the release of "Speaker Deck":http://speakerdeck.com, we released "Qu":https://github.com/bkeepers/qu, a Ruby library for queuing and processing background jobs. Why another queuing library? I briefly explain why I wrote Qu in the "README":https://github.com/bkeepers/qu#readme, so read that first. But I wanted to give a little more of the backstory."
---
