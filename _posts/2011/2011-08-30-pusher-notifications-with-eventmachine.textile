...
- pusher
- redis
excerpt: "We used Redis to queue up notifications to send to Pusher and an EventMachine process to send them in near real-time on "Gaug.es":http://get.gaug.es."
---
