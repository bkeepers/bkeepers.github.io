...
- ruby
- talk
excerpt: "Use toystore and adapter-git to work with the hottest new NoSQL database."
---
...
"Toystore":https://github.com/newtoy/toystore is an ActiveModel-based object mapper for key-value data stores. The beauty of Toystore is that it doesn't care what the backend is. It uses "Adapter":https://github.com/newtoy/adapter to abstract the connection to any data store that can set, get, and delete keys.
