...
- git
- toystore
excerpt: "Using floats between 0 and 1 to specify manual sort order in a key-value data store."
---

p(feedreader). Note: This post contains illustrations that may not appear properly in your feed reader. You may want to view the original post in your browser
